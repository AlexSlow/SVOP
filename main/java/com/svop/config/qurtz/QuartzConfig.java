...
public class QuartzConfig {
    ...
    public SchedulerFactoryBean scheduler(Trigger... triggers) {
        ...
        properties.setProperty("org.quartz.scheduler.instanceName", "SVOP");
        properties.setProperty("org.quartz.scheduler.instanceId", "SVOPID");
        schedulerFactory.setOverwriteExistingJobs(true); //Перезаписать работы
